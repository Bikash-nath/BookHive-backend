...
bookSchema.pre('save', function (next) {
	let slugId
	if (this.ISBN_10) slugId = String(this.ISBN_10)
	else if (this.ISBN_13) slugId = String(this.ISBN_13)
	else slugId = String(Math.round(1000 + Math.random() * 9000))

	this.slug = slugId + '.' + slugify(this.title)
	next()
})
